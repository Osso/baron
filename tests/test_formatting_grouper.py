...
def test_simple_import():
    "import   pouet"
    group(
        [("IMPORT", "import"), ("SPACE", "  "), ("NAME", "pouet")],
        [("IMPORT", "import", [], [("SPACE", "  ")]), ("NAME", "pouet")],
    )
...
def test_import_basic_dot():
    "import   pouet.blob"
    group(
        [("IMPORT", "import"), ("SPACE", "  "), ("NAME", "pouet"), ("DOT", "."), ("NAME", "blob")],
        [("IMPORT", "import", [], [("SPACE", "  ")]), ("NAME", "pouet"), ("DOT", "."), ("NAME", "blob")],
    )
...
def test_import_a_b():
    "import a, b"
    group(
        [("IMPORT", "import"), ("SPACE", " "), ("NAME", "a"), ("COMMA", ","), ("SPACE", " "), ("NAME", "b")],
        [
            ("IMPORT", "import", [], [("SPACE", " ")]),
            ("NAME", "a"),
            ("COMMA", ",", [], [("SPACE", " ")]),
...
def test_from_a_import_star_without_space():
    "from a import*"
    group(
        [("FROM", "from"), ("SPACE", " "), ("NAME", "a"), ("SPACE", " "), ("IMPORT", "import"), ("STAR", "*")],
        [("FROM", "from", [], [("SPACE", " ")]), ("NAME", "a"), ("IMPORT", "import", [("SPACE", " ")]), ("STAR", "*")],
    )
...
def test_from_dot_no_space_import_b():
    "from .import b"
    group(
        [("FROM", "from"), ("SPACE", " "), ("DOT", "."), ("IMPORT", "import"), ("SPACE", " "), ("NAME", "b")],
        [
            ("FROM", "from", [], [("SPACE", " ")]),
            ("DOT", "."),
            ("IMPORT", "import", [], [("SPACE", " ")]),
...
def test_from_no_space_dot_import_b():
    "from. import b"
    group(
        [("FROM", "from"), ("DOT", "."), ("SPACE", " "), ("IMPORT", "import"), ("SPACE", " "), ("NAME", "b")],
        [("FROM", "from"), ("DOT", "."), ("IMPORT", "import", [("SPACE", " ")], [("SPACE", " ")]), ("NAME", "b")],
    )
...
def test_from_no_space_dot_no_sapceimport_b():
    "from.import b"
    group(
        [("FROM", "from"), ("DOT", "."), ("IMPORT", "import"), ("SPACE", " "), ("NAME", "b")],
        [("FROM", "from"), ("DOT", "."), ("IMPORT", "import", [], [("SPACE", " ")]), ("NAME", "b")],
    )
...
def test_simple_power():
    "a**b"
    group([("NAME", "a"), ("DOUBLE_STAR", "**"), ("NAME", "b")], [("NAME", "a"), ("DOUBLE_STAR", "**"), ("NAME", "b")])


def test_first_space_power():
    "a  **b"
    group(
        [("NAME", "a"), ("SPACE", "  "), ("DOUBLE_STAR", "**"), ("NAME", "b")],
        [("NAME", "a"), ("DOUBLE_STAR", "**", [("SPACE", "  ")]), ("NAME", "b")],
    )
...
def test_spaces_power():
    "a **  b"
    group(
        [("NAME", "a"), ("SPACE", " "), ("DOUBLE_STAR", "**"), ("SPACE", "  "), ("NAME", "b")],
        [("NAME", "a"), ("DOUBLE_STAR", "**", [("SPACE", " ")], [("SPACE", "  ")]), ("NAME", "b")],
    )
...
def test_power_power_spaces():
    ...
    "a**b**c"
    group(
        [("NAME", "a"), ("DOUBLE_STAR", "**"), ("NAME", "b"), ("DOUBLE_STAR", "**"), ("NAME", "c")],
        [("NAME", "a"), ("DOUBLE_STAR", "**"), ("NAME", "b"), ("DOUBLE_STAR", "**"), ("NAME", "c")],
    )
...
def test_power_factor():
    "a **  +b"
    group(
        [("NAME", "a"), ("SPACE", " "), ("DOUBLE_STAR", "**"), ("SPACE", "  "), ("PLUS", "+"), ("NAME", "b")],
        [("NAME", "a"), ("DOUBLE_STAR", "**", [("SPACE", " ")], [("SPACE", "  ")]), ("PLUS", "+"), ("NAME", "b")],
    )
...
def test_power_factor_minus():
    "a **  -b"
    group(
        [("NAME", "a"), ("SPACE", " "), ("DOUBLE_STAR", "**"), ("SPACE", "  "), ("MINUS", "-"), ("NAME", "b")],
        [("NAME", "a"), ("DOUBLE_STAR", "**", [("SPACE", " ")], [("SPACE", "  ")]), ("MINUS", "-"), ("NAME", "b")],
    )
...
def test_power_factor_tild():
    "a **  ~b"
    group(
        [("NAME", "a"), ("SPACE", " "), ("DOUBLE_STAR", "**"), ("SPACE", "  "), ("TILDE", "~"), ("NAME", "b")],
        [("NAME", "a"), ("DOUBLE_STAR", "**", [("SPACE", " ")], [("SPACE", "  ")]), ("TILDE", "~"), ("NAME", "b")],
    )
